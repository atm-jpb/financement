...
<script type="text/javascript">
	...
	?>$('#chart_prod_fournisseur').html('<div id="chart_prod_fournisseur" style="height:<?php echo $dash->hauteur?>px; margin-bottom:20px;"></div>');<?
	...
	?>$('#chart_prod_leaser').html('<div id="chart_prod_leaser" style="height:<?php echo $dash->hauteur?>px; margin-bottom:20px;"></div>');<?
