	...
	print $TBS->render('./tpl/simulation.tpl.php'
		...
		,array(
			'simulation'=>array(
				...
				,'marque_materiel'=>(!empty($simulation->marque_materiel) && !in_array($simulation->marque_materiel, $simulation->TMarqueMateriel) ? $langs->trans('Simulation_marque_not_more_available', $simulation->marque_materiel).' - ' : '') . $form->combo('','marque_materiel',$simulation->TMarqueMateriel,$simulation->marque_materiel)
