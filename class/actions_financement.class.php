 ...
 */
	...
	function printSearchForm($parameters, &$object, &$action, $hookmanager) {
		global $langs;
		 ...
		 $res .= printSearchForm(DOL_URL_ROOT.'/compta/facture/list.php', DOL_URL_ROOT.'/compta/facture/list.php', img_object('','invoice').' '.$langs->trans("Factures"), 'products', 'search_ref');
		 $res .= printSearchForm(DOL_URL_ROOT.'/fourn/facture/index.php', DOL_URL_ROOT.'/fourn/facture/index.php', img_object('','invoice').' '.$langs->trans("SupplierInvoice"), 'products', 'search_ref');
