...
class TScore extends TObjetStd {
	function __construct() {
		...
		parent::add_champs('score,rotation_bfr,delai_client,delai_fourn','type=entier;');
		parent::add_champs('encours_conseille,ca,resultat_net,marge_exploitation,marge_nette,ebe,renta_capital,caf,autonomie_fin,capacite_remb,solvabilite_gen,
								liquidite_gen,liquidite_red,charges_fin_ca,endettement,surface_fin,bfr','type=float;');
