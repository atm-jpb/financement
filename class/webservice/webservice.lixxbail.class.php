...
class WebServiceLixxbail extends WebService
{
	...
	{
		if(in_array($this->simulation->entity, array(3, 30))) return 'V'; // telecom et veodis
		if($this->simulation->entity == 2) return '2'; // informatique
		return 'U';
	}
	...
	{
		if(in_array($this->simulation->entity, array(3, 30))) return 'V08Q'; // telecom et veodis
