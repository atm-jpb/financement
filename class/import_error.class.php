...
/**
 *  \file       dev/skeletons/ImportError.class.php
 *  \ingroup    mymodule othermodule1 othermodule2
 *  \brief      This file is an example for a CRUD class file (Create/Read/Update/Delete)
 *				Initialy built by build_class_from_table on 2012-12-23 19:59
 */
...
class ImportError // extends CommonObject
{
	...
	//var $element='ImportError';			//!< Id that identify managed objects
	//var $table_element='ImportError';	//!< Name of table without prefix where object is stored
	...
	function createFromClone($fromid)
	{
		...
		$object=new ImportError($this->db);
