...
class modFinancement extends DolibarrModules
{
	...
	$this->dictionaries=array(
		...
		,'tabsql'=>array(
			...
			,'SELECT f.rowid as rowid, f.fk_nature, f.fk_type_contrat, f.periode, f.date_application, f.base_solde, f.percent, f.percent_nr, f.cape_lrd, f.entity, f.active FROM '.MAIN_DB_PREFIX.'c_financement_conf_solde as f WHERE entity = '.$conf->entity
		...
		,'tabfield'=>array(
			...
			,'code,label,entity'
			,'code,label,entity'
			,'fk_nature,fk_type_contrat,periode,date_application,base_solde,percent,percent_nr,cape_lrd'
			,'code,label'
		)
		,'tabfieldvalue'=>array(
			'code,label,entity'
			...
			,'code,label,entity'
			,'code,label,entity'
			,'fk_nature,fk_type_contrat,periode,date_application,base_solde,percent,percent_nr,cape_lrd,entity'
			,'code,label'
		)
