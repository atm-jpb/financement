...
print '<input type="number" name="FINANCEMENT_CONFORMITE_FRAIS_DOSSIER" min="0" step="0.01" value="'.$conf->global->FINANCEMENT_CONFORMITE_FRAIS_DOSSIER.'" />';
print '&nbsp;';
print '<input type="submit" class="button" value="'.$langs->trans("Enregistrer").'" />';
print '</form>';
print '</td>';
...
print '<input type="number" name="FINANCEMENT_CONFORMITE_ASSURANCE" min="0" step="0.01" value="'.$conf->global->FINANCEMENT_CONFORMITE_ASSURANCE.'" />';
print '&nbsp;';
print '<input type="submit" class="button" value="'.$langs->trans("Enregistrer").'" />';
print '</form>';
print '</td>';
