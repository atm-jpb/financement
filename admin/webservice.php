...
print '<input type="password" name="FINANCEMENT_GRENKE_CODE_CESSION" value="'.$conf->global->FINANCEMENT_GRENKE_CODE_CESSION.'" size="30" />';
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
print '<input type="password" name="FINANCEMENT_GRENKE_CODE_MANDATEE" value="'.$conf->global->FINANCEMENT_GRENKE_CODE_MANDATEE.'" size="30" />';
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
