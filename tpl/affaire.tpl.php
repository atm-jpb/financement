[onshow;block=begin;when [view.mode]=='view']
		...
		<div class="tabs">
		<a class="tabTitle"><img border="0" title="" alt="" src="./img/financement32.png" width="16" height="16"> Affaire</a>
...
[onshow;block=end]				
			...
			<tr><td width="20%">Montant restant à financer</td><td>[affaire.montant_reste; strconv=no]</td></tr>
			</table>
