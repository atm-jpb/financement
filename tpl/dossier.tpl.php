...
[onshow;block=end]
			...
			<td colspan="4">
				...
				<tr>
					<td width="50%" valign="top">
						...
						<tr class="pair"><td>Loyer intercalaire OK ?</td><td>[financement.intercalaireOK; strconv=no]</td></tr>
						<tr class="impair"><td>Frais de dossier</td><td >[financement.frais_dossier; strconv=no; frm=0 000,00] &euro;</td></tr>
						<tr class="pair"><td>Echéance</td><td>[financement.echeance; strconv=no; frm=0 000,00] &euro; ([financement.loyer_actualise; strconv=no; frm=0 000,00] &euro;)</td></tr>
						<tr class="impair"><td>N° prochaine échéance</td><td>[financement.numero_prochaine_echeance; strconv=no]</td></tr>
						<tr class="pair"><td>Date de prochaine échéance</td><td>[financement.date_prochaine_echeance; strconv=no]</td></tr>
						...
						<tr class="pair"><td>Montant de maintenance</td><td>[financement.montant_prestation; strconv=no]</td></tr>
					
						<tr class="impair"><td>Incident de paiement</td><td>[financement.incident_paiement; strconv=no]</td></tr>
						<tr class="pair"><td>Relocation</td><td>[financement.reloc; strconv=no]</td></tr>
						<tr class="impair"><td>Relocation OK ?</td><td>[financement.relocOK; strconv=no]</td></tr>
						<tr class="pair"><td>Encours relocation</td><td>[financement.encours_reloc; strconv=no] &euro;</td></tr>
						...
						<tr class="impair"><td>Assurance</td><td>[financement.assurance; strconv=no; frm=0 000,00] &euro; ([financement.assurance_actualise; strconv=no; frm=0 000,00] &euro;)</td></tr>
						...
						<tr class="pair"><td colspan="2" align="center">&nbsp;</td></tr>
					...
					<td valign="top">
						...
						<tr class="pair"><td>Loyer intercalaire OK ?</td><td>[financementLeaser.intercalaireOK; strconv=no]</td></tr>
						<tr class="impair"><td>Frais de dossier</td><td >[financementLeaser.frais_dossier; strconv=no; frm=0 000,00] &euro;</td></tr>
						<tr class="pair"><td>Echéance</td><td >[financementLeaser.echeance; strconv=no; frm=0 000,00] &euro;</td></tr>
						<tr class="impair"><td>N° prochaine échéance</td><td >[financementLeaser.numero_prochaine_echeance; strconv=no]</td></tr>
						<tr class="pair"><td>Date de prochaine échéance</td><td >[financementLeaser.date_prochaine_echeance; strconv=no;protect=no]</td></tr>
						
						<tr class="impair"><td>Valeur résiduelle</td><td >[financementLeaser.reste; strconv=no; frm=0 000,00] &euro;</td></tr>
						<tr class="pair"><td>Mode de réglement</td><td >[financementLeaser.reglement; strconv=no]</td></tr>
						<tr class="impair"><td>Terme</td><td>[financementLeaser.terme; strconv=no]</td ></tr>
						
						<tr class="pair"><td>Montant de prestation</td><td >[financementLeaser.montant_prestation; strconv=no; frm=0 000,00] &euro;</td></tr>

						<tr class="impair"><td>Incident de paiement</td><td >[financementLeaser.incident_paiement; strconv=no]</td></tr>
						<tr class="pair"><td>Relocation</td><td>[financementLeaser.reloc; strconv=no]</td></tr>
						<tr class="impair"><td>Relocation OK ?</td><td>[financementLeaser.relocOK; strconv=no]</td></tr>
						<tr class="pair"><td>Encours relocation</td><td>[financementLeaser.encours_reloc; strconv=no] &euro;</td></tr>
						...
						<tr class="pair"><td>Bon pour transfert ?</td>
							<td >
						...
						<tr class="pair"><td colspan="2" align="center"><a href="[financementLeaser.detail_fact]">D&eacute;tail facturation</a></td></tr>
		...
		<tr>
			<td>Retrait copies sup.</td><td>[dossier.soldeperso; frm=0 000,00] &euro; [onshow;block=begin; when [view.contrat]==INTEGRAL] ([dossier.soldepersointegrale; frm=0 000,00] &euro;) [onshow;block=end]</td>
