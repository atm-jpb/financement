...
$sql = "SELECT i.date, i.filename, i.fk_user_authorn, c.code, u.login";
$sql.= " FROM ".MAIN_DB_PREFIX."fin_import i ";
$sql.= " LEFT JOIN ".MAIN_DB_PREFIX."fin_const as c ON c.rowid = i.fk_type";
$sql.= " LEFT JOIN ".MAIN_DB_PREFIX."user as u ON i.fk_user_author = u.rowid";
$sql.= " WHERE i.entity = ".$conf->entity;

if ($search_type_import)
{
	$sql.= " AND i.fk_type = ".$db->escape(trim($search_type_import));
}
if ($search_filename)
{
